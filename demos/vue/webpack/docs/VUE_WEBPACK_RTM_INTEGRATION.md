# React Vite 项目 RTM 集成文档

本文档说明 React Vite 项目集成 Agora RTM SDK 的架构设计和实现细节。
...
React Vite 项目使用 Vite 的 `APP_*` 环境变量：
...
│
├── docs/
│   └── REACT_VITE_RTM_INTEGRATION.md   # 本文档
│
